...
View 부분으로는 추후에 React로 따로 구현할 예정이므로 **Router**, **Controller**, **Model** 먼저 구현하겠습니다.
...
Controller는 Model과 View의 중간다리 역할로 **Model이 가져온 데이터를 가공하여 View에 전달**하거나 **View가 요청과 보낸 데이터를 Model에 전달하는 역할**을 합니다.
