...
이번 포스트에선 MVC 패턴 틀만 잡아놓고 다음 포스트에 기능을 추가해보겠습니다.
...
routes 폴더를 만들고 route-test.js파일을 만들어 express router를 작성합니다.
...
controllers 폴더를 만들고 controller-login.js 파일에 output, process 객체로 나누어 기본 틀을 만듭니다.
...
- 디렉터리 구조
  ![mvc-diretory](/assets/img/mvc-diretory.png){: .w-80 .normal}
