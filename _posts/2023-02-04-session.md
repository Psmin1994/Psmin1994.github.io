...
- http://localhost:3000/session/delete 로 접속해 세션이 삭제되어 console.log(req.session) 출력 결과 num 삭제된 것을 확인할 수 있습니다.
...
따라서, 저희는 express-mysql-session 모듈을 이용해 mysql에 세션을 유지해보겠습니다.
