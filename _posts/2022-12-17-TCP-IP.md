...
- `1 Layer - 네트워크 엑세스 계층 (Network Access Layer)`  
...
> MAC 주소 : 물리적인 주소로 장비의 고유 값을 의미합니다.  
> 12개의 16진수로 구성 (aa-aa-aa-bb-bb-bb)  
> OUI : 앞의 6개 (aa-aa-aa)는 IEEE에서 부여한 제조회사 식별 ID  
> 고유번호 : 뒤의 6개 (bb-bb-bb)는 제조회사에서 부여한 장비 식별 번호
