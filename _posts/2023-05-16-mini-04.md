...
- **개념적 데이터 모델링**
  ...
  - **개체 명세서**
    ...
    ![mini-entity](/assets/img/mini-entity.png){: .w-80 .left}

  - **관계 명세서**

    ![mini-relation](/assets/img/mini-relation.png){: .w-80 .left}

- **논리적 데이터 모델링**

  - **릴레이션 스키마**

    ![mini-relation-schema](/assets/img/mini-relation-schema.png){: .w-80 .left}

  - **테이블 명세서**

    ![mini-table](/assets/img/mini-table.png){: .w-80 .left}

  - **최종 ER 다이어그램**

    ![mini-erd](/assets/img/mini-erd.png){: .w-80 .left}

- **물리적 데이터 모델링**

  Mysql에 EERD 모델을 만들어서 테이블을 생성합니다.

  ![mini-eerd](/assets/img/mini-eerd.png){: .w-80 .left}
...
- post 테이블에서 글 번호, 제목, 내용 데이터 모두 얻어오기
  ...
  ![mini-postman-01](/assets/img/mini-postman-01.png){: .w-80 .left}

  ![mini-postman-02](/assets/img/mini-postman-02.png){: .w-80 .left}

- comment 테이블에서 주어진 글 번호에 맞는 댓글 데이터 모두 얻어오기

  ![mini-postman-03](/assets/img/mini-postman-03.png){: .w-80 .left}

  ![mini-postman-04](/assets/img/mini-postman-04.png){: .w-80 .left}
