...
- post 테이블에서 글 번호, 제목, 내용 데이터 모두 얻어오기
  ...
  ![mini-postman-01](/assets/img/mini-postman-01.jpg){: .w-80}

  ![mini-postman-02](/assets/img/mini-postman-02.jpg){: .w-80}

- comment 테이블에서 주어진 글 번호에 맞는 댓글 데이터 모두 얻어오기

  ![mini-postman-03](/assets/img/mini-postman-03.jpg){: .w-80}

  ![mini-postman-04](/assets/img/mini-postman-04.jpg){: .w-80}
